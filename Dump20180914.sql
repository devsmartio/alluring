...
INSERT INTO `app_profile` VALUES (1,'Super Admin',1),(2,'Ventas',1),(3,'Admin',1),(4,'Pruebas',1);
...
INSERT INTO `app_profile_access` VALUES (1,1),(1,2),(3,2),(1,3),(3,3),(1,4),(1,5),(3,5),(1,8),(3,8),(1,13),(1,17),(3,17),(1,18),(3,18),(1,19),(3,19),(1,20),(3,20),(1,22),(2,22),(3,22),(1,23),(2,23),(3,23),(1,24),(2,24),(3,24),(1,25),(2,25),(3,25),(1,28),(2,28),(3,28),(1,29),(2,29),(3,29),(1,30),(2,30),(3,30),(1,31),(2,31),(3,31),(1,32),(2,32),(3,32),(1,33),(2,33),(3,33),(1,34),(2,34),(3,34),(1,35),(2,35),(3,35),(1,36),(2,36),(3,36),(1,37),(2,37),(3,37),(1,38),(2,38),(3,38);
...
INSERT INTO `clientes` VALUES (44,'Silvia','Morales','15 Calle Ciudad','5982349872',1,2,1,'yicm@gmail.com',1,3,0,'',15,'09850985-0','Silvia Morales','15 Calle Ciudad',NULL,NULL,'d41d8cd98f00b204e9800998ecf8427e','2018-09-12 20:35:08','Pruebas ');
...
INSERT INTO `empleados` VALUES (3,'Alluring','Empleado 1',5,'2018-09-04 22:57:12','Pruebas ','169','cHJ1ZWJhcw',''),(4,'Sam','Fernandez',5,'2018-09-12 20:51:33','Pruebas ','3','cHJ1ZWJhcw','');
...
INSERT INTO `generacion_etiquetas` VALUES ('Y1',10.00,5),('Y1',10.00,4),('Y03',5.00,5),('Y03',5.00,4),('Y01',5.00,5),('Y01',5.00,4);
...
INSERT INTO `paises` VALUES (1,'Guatemala','Pruebas ','2017-09-06 08:04:21'),(2,'El Salvador','Pruebas ','2018-07-20 23:40:33'),(3,'Honduras','Pruebas ','2018-09-12 20:13:34');
...
INSERT INTO `producto` VALUES (14,'Producto 2','Desc Producto 2','2018-09-12 19:03:52','Pruebas ',25.00,1,50.00,'Y2.jpg','Y2'),(15,'Producto 3','Desc Producto 3','2018-09-05 20:54:12','Pruebas ',50.00,1,75.00,'Y3.jpg','Y3'),(16,'Producto 1','Desc Producto 1','2018-09-05 20:54:12','Pruebas ',25.00,1,100.00,'Y1.jpg','Y1'),(18,'Anillo de compromiso con CZ','Anillo de compromiso con circonia y corte princesa','2018-09-12 20:25:22','Pruebas ',50.00,1,100.00,'Y4.jpg','Y4'),(19,'Producto 2','Desc Producto 2','2018-09-12 20:43:07','Pruebas ',25.00,1,50.00,'Y02.jpeg','Y02'),(20,'Producto 3','Desc Producto 3','2018-09-12 20:43:07','Pruebas ',50.00,1,75.00,'Y03.jpeg','Y03'),(21,'Producto 1','Desc Producto 1','2018-09-12 20:43:07','Pruebas ',50.00,1,35.00,'Y01.jpeg','Y01'),(22,'Producto 4 ','Desc Poducto 4','2018-09-12 20:45:48','Pruebas ',50.00,1,100.00,'Y04.jpeg','Y04');
...
--
-- Temporary view structure for view `reporte_inventario`
--
...
/*!50001 CREATE VIEW `reporte_inventario` AS SELECT 
 ...
 1 AS `total_existencias`,
 1 AS `id_sucursal`,
 1 AS `id_tipo`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `reporte_venta_detalle`
--

DROP TABLE IF EXISTS `reporte_venta_detalle`;
/*!50001 DROP VIEW IF EXISTS `reporte_venta_detalle`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `reporte_venta_detalle` AS SELECT 
 1 AS `codigo_origen`,
 1 AS `nombre_producto`,
 1 AS `cantidad`,
 1 AS `id_sucursal`,
...
--
-- Temporary view structure for view `reporte_ventas`
--

DROP TABLE IF EXISTS `reporte_ventas`;
/*!50001 DROP VIEW IF EXISTS `reporte_ventas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `reporte_ventas` AS SELECT 
 1 AS `nombre_sucursal`,
 1 AS `nombre_cliente`,
 1 AS `venta`,
 1 AS `id_sucursal`,
...
INSERT INTO `trx_transacciones` VALUES (179,2,3,5,'Carga Masiva Productos',1,14,0.00,5.00,'2018-09-05 20:54:12',NULL),(180,2,3,4,'Carga Masiva Productos',1,14,0.00,5.00,'2018-09-05 20:54:12',NULL),(181,2,3,5,'Carga Masiva Productos',1,15,0.00,5.00,'2018-09-05 20:54:12',NULL),(182,2,3,4,'Carga Masiva Productos',1,15,0.00,5.00,'2018-09-05 20:54:12',NULL),(183,2,3,5,'Carga Masiva Productos',1,16,0.00,5.00,'2018-09-05 20:54:12',NULL),(184,2,3,4,'Carga Masiva Productos',1,16,0.00,5.00,'2018-09-05 20:54:12',NULL),(185,2,3,5,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:43:07',NULL),(186,2,3,4,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:43:07',NULL),(187,2,3,5,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:43:07',NULL),(188,2,3,4,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:43:07',NULL),(189,2,3,5,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:43:07',NULL),(190,2,3,4,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:43:07',NULL),(191,2,3,5,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:43:44',NULL),(192,2,3,4,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:43:44',NULL),(193,2,3,5,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:43:44',NULL),(194,2,3,4,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:43:44',NULL),(195,2,3,5,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:43:44',NULL),(196,2,3,4,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:43:44',NULL),(197,2,3,5,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:45:48',NULL),(198,2,3,4,'Carga Masiva Productos',1,19,0.00,5.00,'2018-09-12 20:45:48',NULL),(199,2,3,5,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:45:48',NULL),(200,2,3,4,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:45:48',NULL),(201,2,3,5,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:45:48',NULL),(202,2,3,4,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:45:48',NULL),(203,2,3,5,'Carga Masiva Productos',1,22,0.00,5.00,'2018-09-12 20:45:48',NULL),(204,2,3,4,'Carga Masiva Productos',1,22,0.00,5.00,'2018-09-12 20:45:48',NULL),(205,2,3,5,'Carga Masiva Productos',1,16,0.00,10.00,'2018-09-12 20:48:19',NULL),(206,2,3,4,'Carga Masiva Productos',1,16,0.00,10.00,'2018-09-12 20:48:19',NULL),(207,2,3,5,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:48:19',NULL),(208,2,3,4,'Carga Masiva Productos',1,20,0.00,5.00,'2018-09-12 20:48:19',NULL),(209,2,3,5,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:48:19',NULL),(210,2,3,4,'Carga Masiva Productos',1,21,0.00,5.00,'2018-09-12 20:48:19',NULL),(211,4,3,5,'Venta',1,16,10.00,0.00,'2018-09-12 21:31:46',44);
...
INSERT INTO `trx_venta` VALUES (18,1000.00,44,3,'V','Pruebas ','2018-09-12 21:31:46');
...
INSERT INTO `trx_venta_detalle` VALUES (1,18,16,5,10.00,100.00,'Pruebas ','2018-09-12 21:31:46');
...
INSERT INTO `trx_venta_formas_pago` VALUES (1,18,1,1,1000.00,1000.00,NULL,NULL,NULL,NULL,NULL,'Pruebas ','2018-09-12 21:31:46');
...
/*!50001 VIEW `reporte_clientes` AS select `c`.`identificacion` AS `identificacion`,`c`.`nombres` AS `nombres`,`c`.`apellidos` AS `apellidos`,`c`.`factura_nit` AS `factura_nit`,`t`.`numero` AS `numero`,`c`.`direccion` AS `direccion`,`c`.`tiene_credito` AS `tiene_credito`,`c`.`dias_credito` AS `dias_credito`,`c`.`id_departamento` AS `id_departamento`,`c`.`id_empleado` AS `id_empleado` from (`clientes` `c` left join `clientes_telefonos` `t` on((`t`.`id_cliente` = `c`.`id_cliente`))) */;
...
--
-- Final view structure for view `reporte_venta_detalle`
--
...
-- Dump completed on 2018-09-14 15:15:44
