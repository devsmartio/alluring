...
if (!defined('PICQER_ROOT')) {
    define("PICQER_ROOT", str_replace(DIRECTORY_SEPARATOR, '/', realpath(dirname(__FILE__))));
}


require_once(PICQER_ROOT . "/Exceptions/BarcodeException.php");
require_once(PICQER_ROOT . "/Exceptions/InvalidCharacterException.php");
require_once(PICQER_ROOT . "/Exceptions/InvalidCheckDigitException.php");
require_once(PICQER_ROOT . "/Exceptions/InvalidFormatException.php");
require_once(PICQER_ROOT . "/Exceptions/InvalidLengthException.php");
require_once(PICQER_ROOT . "/Exceptions/UnknownTypeException.php");

//use DOMPDF_DIR \Exceptions\BarcodeException;
