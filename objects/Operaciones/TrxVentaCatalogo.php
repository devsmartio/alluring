...
class TrxVentaCatalogo extends FastTransaction {
    function __construct(){
        parent::__construct();
        $this->instanceName = 'TrxVentaCatalogo';
        $this->setTitle('Venta catálogo');
    ...
    protected function showModule() {
        include VIEWS . "/venta_catalogo.phtml";
    }
...
console.log("PROD AGREGAR: ", prod);
    ...
    public function getClientes()
    {
        $resultSet = array();
        $user = $this->user['ID'];
        $dsClientes = $this->db->query_select('clientes', sprintf("id_usuario='%s'", $user));
    ...
    public function getProductos(){
        ...
        echo json_encode(array('data' => sanitize_array_by_keys($productos, ['nombre', 'descripcion', 'nombre_categoria', 'nombre_sucursal'])));
    }
