...
/**
 * Description of IngredienteTable
 *
 * @author Bryan C
 */
class IngredienteTable extends MaintenanceTable{
    private static $ID = 'idIngrediente';
    ...
    private static $MEDIDA = 'unidad_medida';
    ...
    protected function init() {
        ...
        $this->gridCols = array(
            ...
            new AngularGridColumn(self::$MEDIDA, 'Unidad de medida', false, '15%', true, 
                    new SelectTemplate('idUnidad_Medida', 'nombre', UnidadMedidaTable::getMe(), true)),
