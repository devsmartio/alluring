...
class RptVentas extends FastReport {
    function __construct() {
        ...
        $params = [
            ...
            new FastField('Fecha desde', 'fecha_desde', 'datepicker', 'text', true, null, array(), false),
            new FastField('Fecha hasta', 'fecha_hasta', 'datepicker', 'text', true, null, array(), false)
        ];
